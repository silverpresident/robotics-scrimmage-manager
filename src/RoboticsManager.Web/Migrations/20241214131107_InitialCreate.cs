...
namespace RoboticsManager.Web.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    TeamNo = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChallengeCompletions_Teams_TeamId",
                        column: x => x.TeamId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChallengeCompletionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Updates_Announcements_AnnouncementId",
                        column: x => x.AnnouncementId,
                        principalTable: "Announcements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Updates_ChallengeCompletions_ChallengeCompletionId",
                        column: x => x.ChallengeCompletionId,
                        principalTable: "ChallengeCompletions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Updates_Challenges_ChallengeId",
                        column: x => x.ChallengeId,
                        principalTable: "Challenges",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Updates_Teams_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Teams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChallengeCompletions_TeamId_ChallengeId",
                table: "ChallengeCompletions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teams_TeamNo",
                table: "Teams",
                column: "TeamNo",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Updates_AnnouncementId",
                table: "Updates",
                column: "AnnouncementId");

            migrationBuilder.CreateIndex(
                name: "IX_Updates_ChallengeCompletionId",
                table: "Updates",
                column: "ChallengeCompletionId");

            migrationBuilder.CreateIndex(
                name: "IX_Updates_ChallengeId",
                table: "Updates",
                column: "ChallengeId");

            migrationBuilder.CreateIndex(
                name: "IX_Updates_TeamId",
                table: "Updates",
                column: "TeamId");
        }
